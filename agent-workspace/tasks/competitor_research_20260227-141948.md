...
5) Browser proof:
   - For each app, after opening a source page, run browser snapshot and save JSON under:
     OPS/research_artifacts/20260227-141948/<slug>_snapshot.json
   - Best-effort: one screenshot per app into the same folder.
6) Commit:
   - Message: "Phase9: competitor scan (agent browser proof)"
   - Commit body must include: OPS/research_artifacts/20260227-141948
